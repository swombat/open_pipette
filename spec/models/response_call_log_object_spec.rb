...
# Unit tests for OpenPipette::ResponseCallLogObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenPipette::ResponseCallLogObject do
  let(:instance) { OpenPipette::ResponseCallLogObject.new }

  describe 'test an instance of ResponseCallLogObject' do
    it 'should create an instance of ResponseCallLogObject' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenPipette::ResponseCallLogObject)
    end
  end
