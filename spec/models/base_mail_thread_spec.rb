...
# Unit tests for OpenPipette::BaseMailThread
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenPipette::BaseMailThread do
  let(:instance) { OpenPipette::BaseMailThread.new }

  describe 'test an instance of BaseMailThread' do
    it 'should create an instance of BaseMailThread' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenPipette::BaseMailThread)
    end
  end
