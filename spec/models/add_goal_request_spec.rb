...
# Unit tests for OpenPipette::AddGoalRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenPipette::AddGoalRequest do
  let(:instance) { OpenPipette::AddGoalRequest.new }

  describe 'test an instance of AddGoalRequest' do
    it 'should create an instance of AddGoalRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenPipette::AddGoalRequest)
    end
  end
