...
# Unit tests for OpenPipette::MailMessageResponse200AllOfData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenPipette::MailMessageResponse200AllOfData do
  let(:instance) { OpenPipette::MailMessageResponse200AllOfData.new }

  describe 'test an instance of MailMessageResponse200AllOfData' do
    it 'should create an instance of MailMessageResponse200AllOfData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenPipette::MailMessageResponse200AllOfData)
    end
  end
