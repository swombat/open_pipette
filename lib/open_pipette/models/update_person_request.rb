...
module OpenPipette
  class UpdatePersonRequest
    ...
    attr_accessor :marketing_status
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenPipette::UpdatePersonRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenPipette::UpdatePersonRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'marketing_status')
        self.marketing_status = attributes[:'marketing_status']
      end
    ...
    def valid?
      ...
      marketing_status_validator = EnumAttributeValidator.new('String', ["no_consent", "unsubscribed", "subscribed", "archived"])
      return false unless marketing_status_validator.valid?(@marketing_status)
      true
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] marketing_status Object to be assigned
    def marketing_status=(marketing_status)
      validator = EnumAttributeValidator.new('String', ["no_consent", "unsubscribed", "subscribed", "archived"])
      unless validator.valid?(marketing_status)
        fail ArgumentError, "invalid value for \"marketing_status\", must be one of #{validator.allowable_values}."
      end
      @marketing_status = marketing_status
    end
    ...
    def hash
      [name, owner_id, org_id, email, phone, label, visible_to, marketing_status, add_time].hash
    end
