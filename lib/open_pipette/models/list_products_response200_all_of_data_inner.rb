...
module OpenPipette
  class ListProductsResponse200AllOfDataInner
    ...
    attr_accessor :sum_formatted

    # The formatted quantity of the product
    attr_accessor :quantity_formatted
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenPipette::ListProductsResponse200AllOfDataInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenPipette::ListProductsResponse200AllOfDataInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'last_edit')
        self.last_edit = attributes[:'last_edit']
      end
      ...
      if attributes.key?(:'sum_formatted')
        self.sum_formatted = attributes[:'sum_formatted']
      end

      if attributes.key?(:'quantity_formatted')
        self.quantity_formatted = attributes[:'quantity_formatted']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          sum_formatted == o.sum_formatted &&
          quantity_formatted == o.quantity_formatted &&
          quantity == o.quantity &&
          product == o.product
    end
    ...
    def hash
      [id, deal_id, order_nr, product_id, product_variation_id, item_price, discount, discount_type, sum, currency, enabled_flag, add_time, last_edit, comments, active_flag, tax, tax_method, name, sum_formatted, quantity_formatted, quantity, product].hash
    end
