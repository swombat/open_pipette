...
module OpenPipette
  ...
  class GetAddProductAttachementResponse200Data
    ...
    # The ID of the deal-product (the ID of the product attached to the deal)
    attr_accessor :product_attachment_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenPipette::GetAddProductAttachementResponse200Data` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenPipette::GetAddProductAttachementResponse200Data`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'product_attachment_id')
        self.product_attachment_id = attributes[:'product_attachment_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          product_attachment_id == o.product_attachment_id
    end
    ...
    def hash
      [product_id, item_price, quantity, discount, discount_type, product_variation_id, comments, tax, tax_method, enabled_flag, billing_frequency, billing_frequency_cycles, billing_start_date, id, company_id, deal_id, sum, currency, add_time, last_edit, active_flag, name, product_attachment_id].hash
    end
