...
module OpenPipette
  class GetCurrentUserResponse200AllOfData
    # The user ID
    attr_accessor :id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenPipette::GetCurrentUserResponse200AllOfData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenPipette::GetCurrentUserResponse200AllOfData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'company_industry')
        self.company_industry = attributes[:'company_industry']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          company_industry == o.company_industry &&
          language == o.language
    end
    ...
    def hash
      [id, name, default_currency, locale, lang, email, phone, activated, last_login, created, modified, has_created_company, access, active_flag, timezone_name, timezone_offset, role_id, icon_url, is_you, is_deleted, company_id, company_name, company_domain, company_country, company_industry, language].hash
    end
