...
module OpenPipette
  class ReceiveMessageRequest
    ...
    attr_accessor :conversation_link
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenPipette::ReceiveMessageRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenPipette::ReceiveMessageRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'reply_by')
        self.reply_by = attributes[:'reply_by']
      end

      if attributes.key?(:'conversation_link')
        self.conversation_link = attributes[:'conversation_link']
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["sent", "delivered", "read", "failed"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["sent", "delivered", "read", "failed"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          reply_by == o.reply_by &&
          conversation_link == o.conversation_link &&
    ...
    def hash
      [id, channel_id, sender_id, conversation_id, message, status, created_at, reply_by, conversation_link, attachments].hash
    end
