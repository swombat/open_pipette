...
module OpenPipette
  class GetStagesResponse200DataInner
    # The ID of the stage
    attr_accessor :id
    ...
    attr_accessor :pipeline_deal_probability
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenPipette::GetStagesResponse200DataInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenPipette::GetStagesResponse200DataInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'pipeline_deal_probability')
        self.pipeline_deal_probability = attributes[:'pipeline_deal_probability']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          pipeline_deal_probability == o.pipeline_deal_probability
    end
    ...
    def hash
      [id, order_nr, name, active_flag, deal_probability, pipeline_id, rotten_flag, rotten_days, add_time, update_time, pipeline_name, pipeline_deal_probability].hash
    end
