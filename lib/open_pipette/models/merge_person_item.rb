...
module OpenPipette
  class MergePersonItem
    ...
    attr_accessor :participant_open_deals_count

    # The count of closed participant deals related with the item
    attr_accessor :participant_closed_deals_count
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenPipette::MergePersonItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenPipette::MergePersonItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'participant_open_deals_count')
        self.participant_open_deals_count = attributes[:'participant_open_deals_count']
      end

      if attributes.key?(:'participant_closed_deals_count')
        self.participant_closed_deals_count = attributes[:'participant_closed_deals_count']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          participant_open_deals_count == o.participant_open_deals_count &&
          participant_closed_deals_count == o.participant_closed_deals_count
    end
