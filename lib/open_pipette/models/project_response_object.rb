...
module OpenPipette
  class ProjectResponseObject
    ...
    attr_accessor :status_change_time
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenPipette::ProjectResponseObject` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenPipette::ProjectResponseObject`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'status_change_time')
        self.status_change_time = attributes[:'status_change_time']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          status_change_time == o.status_change_time &&
    ...
    def hash
      [id, title, board_id, phase_id, description, status, owner_id, start_date, end_date, deal_ids, org_id, person_id, labels, add_time, update_time, status_change_time, archive_time].hash
    end
