...
module OpenPipette
  ...
  class GetOrganizationsResponse200AllOfRelatedObjectsPicturePICTUREID
    ...
    def self.openapi_types
      {
        ...
        :'pictures' => :'PersonItemAllOfPictureIdAllOfPictures'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenPipette::GetOrganizationsResponse200AllOfRelatedObjectsPicturePICTUREID` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenPipette::GetOrganizationsResponse200AllOfRelatedObjectsPicturePICTUREID`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'added_by_user_id')
        self.added_by_user_id = attributes[:'added_by_user_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          added_by_user_id == o.added_by_user_id &&
          pictures == o.pictures
    end
    ...
    def hash
      [id, item_type, item_id, active_flag, add_time, update_time, added_by_user_id, pictures].hash
    end
