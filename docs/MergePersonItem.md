...
| **merge_what_id** | **Integer** | The ID of the person with what the main person was merged | [optional] |
...
| **participant_open_deals_count** | **Integer** | The count of open participant deals related with the item | [optional] |
| **participant_closed_deals_count** | **Integer** | The count of closed participant deals related with the item | [optional] |
...
instance = OpenPipette::MergePersonItem.new(
  id: null,
  company_id: null,
  active_flag: null,
  phone: null,
